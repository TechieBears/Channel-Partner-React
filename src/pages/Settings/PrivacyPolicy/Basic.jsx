    ...
    return (
        ...
        >
            <div className="bg-white p-4 mb-6 rounded-lg">
                <div className="">
                    <h1 className='font-tbPop text-xl font-semibold text-gray-900 '>Basic's</h1>
                </div>
                <form>
            ...
            <div className="bg-white p-4 mb-6 rounded-lg">
                <div className="">
                    <h1 className='font-tbPop text-xl font-semibold text-gray-900 '>Cancelation Policy</h1>
                </div>
                <form>
                    <div className="p-4 overflow-y-scroll scrollbars ">
                        <div className="py-4 mx-4 grid md:grid-cols-1 lg:grid-cols-2 gap-x-3 gap-y-3 customBox">
