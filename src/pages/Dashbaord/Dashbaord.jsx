...
import DashboardForm from '../../components/modals/DashbaordModals/DashbardForm'
import Table from '../../components/table/Table';
import { ArrowSwapVertical, Box, Chart2, NotificationBing, ShoppingCart } from 'iconsax-react';
    ...
    return (
        <>
            <section className='h-full w-full'>
                <div className="bg-white p-8 m-4 sm:m-5 rounded-2xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-y-10 " data-aos="fade-up" data-aos-duration="1000" delay="100">
                    ...
                    <div className="flex items-center space-x-3 border-r-0 md:border-r mr-8 border-gray-200/70">
                        <div className="p-3.5 rounded-xl bg-sky-50">
                            <Box size={26} className="text-sky-500" />
                        </div>
                        <div className="space-y-1">
                            <h6 className='text-gray-500 font-tb text-sm'>Order Completed</h6>
                            <h6 className='text-sky-500 font-tb font-semibold text-base'>1.237k</h6>
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-2xl m-4 sm:m-5 shadow-sm  p-5 sm:p-7 " data-aos="fade-up" data-aos-duration="1500" delay="100">
                    <div className="flex justify-between flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 mb-6">
                        <div className="">
                            <h1 className='font-tb text-xl font-semibold text-gray-900 '>Admin Dashbaord</h1>
                            <h6 className='text-gray-500 font-tb text-sm'>Top selling products in your store</h6>
                        </div>
                        <DashboardForm />
                    </div>
