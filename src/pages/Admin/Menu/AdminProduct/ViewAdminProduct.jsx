            ...
            <div className='grid grid-cols-3 p-4 bg-white rounded-xl'>
                ...
                <div className='space-y-4'>
                    ...
                    <div>
                        ...
                        <p className='text-sm text-gray-600'>{product?.product_subcategory?.subcat_name}</p>
                    </div>
                </div>
                <div className='space-y-4'>
                    <div>
                        <p className='text-lg font-semibold'>ISB</p>
                        <p className='text-sm text-gray-600'>{product?.vendor?.isb_code}</p>
                    </div>
                    <div>
                        <p className='text-lg font-semibold'>Shop Name</p>
                        <p className='text-sm text-gray-600'>{product?.vendor?.shop_name}</p>
                    </div>
                </div>
                {/* <div className='w-96'>
                    <SimpleGallery
