...
// import { createMovableCategory, editMovableCategory, getMovableCategory } from '../../../../api';
                                            ...
                                            <div className="py-4 mx-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4  gap-x-3 gap-y-3 ">
                                                ...
                                                <div className="">
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <textarea className={inputClass} name="" id="" cols="30" rows="4" placeholder='Enter Phone Number' 
                                                        //  {...register('phone_no', { required: true, validate: validatePhoneNumber })}
                                                        >
