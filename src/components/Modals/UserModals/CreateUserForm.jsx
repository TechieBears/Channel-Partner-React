                                                ...
                                                <div className="grid grid-cols-1 py-4 mx-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-x-3 gap-y-3">
                                                    ...
                                                    {/* <div className="">
                                                        ...
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            />
                                                            <div className="">
                                                                <label htmlFor='cheque' className={`${cheque_watch?.length || props?.data?.cheque_url ? "bg-sky-400 text-white" : " bg-gray-300/80"}  transition-colors hover:bg-sky-400 font-tb font-semibold hover:text-white py-3 mt-10 px-5 rounded-md cursor-pointer`}>
                                                                    Upload
                                                                </label>
                                                                <input className="hidden"
                                                                    id="cheque"
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            />
                                                            <div className="">
                                                                <label htmlFor='fssai' className={`${fssai_watch?.length || props?.data?.fssai_url ? "bg-sky-400 text-white" : " bg-gray-300/80"}  transition-colors hover:bg-sky-400 font-tb font-semibold hover:text-white py-3 mt-10 px-5 rounded-md cursor-pointer`}>
                                                                    Upload
                                                                </label>
                                                                <input className="hidden"
                                                                    id="fssai"
                                                    ...
                                                    {/* <div className="">
                                                        ...
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            />
                                                            <div className="">
                                                                <label htmlFor='bus_card' className={`${buscard_watch?.length || props?.data?.bus_card_url ? "bg-sky-400 text-white" : " bg-gray-300/80"}  transition-colors hover:bg-sky-400 font-tb font-semibold hover:text-white py-3 mt-10 px-5 rounded-md cursor-pointer`}>
                                                                    Upload
                                                                </label>
                                                                <input className="hidden"
                                                                    id="bus_card"
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            />
                                                            <div className="">
                                                                <label htmlFor='odoc' className={`${odoc_watch?.length || props?.data?.odoc_url ? "bg-sky-400 text-white" : " bg-gray-300/80"}  transition-colors hover:bg-sky-400 font-tb font-semibold hover:text-white py-3 mt-10 px-5 rounded-md cursor-pointer`}>
                                                                    Upload
                                                                </label>
                                                                <input className="hidden"
                                                                    id="odoc"
